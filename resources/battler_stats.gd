...
## Stats for a battle participant. Turn order is determined by speed (higher = earlier turn).
...
@export var speed: int = 10  ## Higher speed = acts earlier in turn order
@export var is_party: bool = true  ## true = ally (one of 4), false = enemy (1-4)
